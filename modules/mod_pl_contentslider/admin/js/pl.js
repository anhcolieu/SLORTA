...
window.addEvent("domready",function(){
	...
	jQuery('#module-sliders li > .pln-group').each(function(){
	...
	// Group element
	jQuery(".pl_control").each(function(){ 
...
function BtParamsChoose(){
	...
	if(jQuery("#jform_params_source").val().indexOf("plportfolio")>=0){
		if(jQuery("#jform_params_plportfolio_category option").length==0){
