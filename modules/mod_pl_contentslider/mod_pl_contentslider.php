...
require_once JPATH_SITE.'/modules/mod_pl_contentslider/helpers/helper.php';
//Get list content
...
$preloadImg = JURI::root().'/modules/mod_pl_contentslider/tmpl/images/loading.gif';
...
$modid = '#plcontentslider'.$module->id;
