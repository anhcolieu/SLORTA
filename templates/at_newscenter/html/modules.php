...
function modChrome_style_hd($module, &$params, &$attribs)
{
...
title="<?php echo JText::_('TPL_CLICK'); ?>"
onclick="on('module_<?php echo $module->id; ?>'); return false"
class="opencloselink" id="link_<?php echo $module->id?>"> <span
class="no"><img src="templates/at_newscenter/images/dropdown/dropdown_pl.png"
alt="<?php if ($state == 1) { echo JText::_('TPL_ALTEXPAND');} else {echo JText::_('TPL_ALTCOLLAPSE');} ?>" />
...
function modChrome_style_tb($module, $params, $attribs)
{
...
{
echo '<a href="#" class="unseen" onclick="nexttab(\'module_'. $rendermodule->id.'\');return false;" id="next_'.$rendermodule->id.'">'.JText::_('TPL_NEXTTAB').'</a>';
}
echo '</div>';
}
$modulecount--;
