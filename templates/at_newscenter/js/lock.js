...
/*global window, localStorage, Cookie, altexpand, altcollapse, lwrap, swrap, expandcolright, collapsecolright, dropl, dropmin */
	...
	// if rightcolumn
		if (what != null) {
			...
			if (rightcookie == 'none') {
				...
				grafik.innerHTML = expandcolright;
				grafik.focus();
			}
		}
	});
...
function on(key) {
	...
	if (el.style.display == 'none') {
		...
		if (key == 'right') {
			...
			document.id('bild').innerHTML = collapsecolright;
			grafik.focus();
		}
	} else {
		el.setStyle('display', 'none');
